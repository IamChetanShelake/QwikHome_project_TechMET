            ...
            <div class="form-header">
                <div class="form-title-group">
                    ...
                    <div class="form-title-text">
                        ...
                        <p class="form-subtitle">Update employee information and settings</p>
                    </div>
                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-input"
                                           value="{{ old('name', $serviceProvider->name) }}" placeholder="Enter full name" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-input"
                                           value="{{ old('email', $serviceProvider->email) }}" placeholder="Enter email address" required>
                                    @error('email')
                                        <div class="error-message">
                                            <i class="fas fa-exclamation-circle"></i>
                                            {{ $message }}
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="phone" name="phone" class="form-input"
                                           value="{{ old('phone', $serviceProvider->phone) }}" placeholder="Enter phone number">
                                    @error('phone')
                                        <div class="error-message">
                                            <i class="fas fa-exclamation-circle"></i>
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    <label for="password" class="form-label">
                                        ...
                                        Password <span class="optional">(Leave empty to keep current)</span>
                                    </label>
                            ...
                            <div class="form-row">
                                <div class="form-group full-width">
                                    ...
                                    <textarea id="address" name="address" class="form-textarea"
                                              placeholder="Enter complete address">{{ old('address', $serviceProvider->address) }}</textarea>
                                    @error('address')
                                        <div class="error-message">
                                            <i class="fas fa-exclamation-circle"></i>
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="current-image-display">
                                        @if($serviceProvider->image)
                                            <img src="{{ asset('user_images/' . $serviceProvider->image) }}" alt="{{ $serviceProvider->name }}" class="current-image">
                                            <small class="image-note">Leave image field empty to keep current image</small>
                                        @else
                                            <div class="no-current-image">
                                                <i class="fas fa-user"></i>
                                                <span>No image uploaded</span>
                                            </div>
                                            <small class="image-note">Upload a new image using the field above</small>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                            ...
                                            @foreach($services as $service)
                                                <div class="service-item" data-category="{{ $service->category_id }}" data-subcategory="{{ $service->subcategory_id }}">
                                                    <input type="checkbox" name="services[]" value="{{ $service->id }}" id="service_{{ $service->id }}" class="service-checkbox"
                                                           {{ in_array($service->id, old('services', $serviceProvider->services->pluck('id')->toArray())) ? 'checked' : '' }}>
