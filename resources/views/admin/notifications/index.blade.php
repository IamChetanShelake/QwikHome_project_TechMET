...
@section('content')
    <style>
        ...
        .index-header-section { background: #ffffff; border-radius: 20px; padding: 30px; border: 1px solid #e2e8f0; display:flex; justify-content:space-between; align-items:center; gap:20px; margin-bottom:20px; }
        ...
        .header-title { font-size:28px; font-weight:700; color:#1e293b; margin:0; }
        .header-subtitle { font-size:14px; color:#64748b; margin:5px 0 0 0; }
        .filters-section { background: #ffffff; border-radius: 15px; padding: 25px; border: 1px solid #e2e8f0; margin-bottom: 20px; }
        ...
        .filter-label { display:flex; align-items:center; gap:8px; font-size:14px; font-weight:600; color:#334155; }
        .modern-filter-input, .modern-filter-select { padding:12px 16px; background:#f8fafc; border:2px solid #e2e8f0; border-radius:10px; color:#334155; font-size:14px; transition:all .3s ease; }
        .modern-filter-input:focus, .modern-filter-select:focus { outline:none; border-color:#00d4ff; background:#ffffff; box-shadow:0 0 15px rgba(0,212,255,0.2); }
        ...
        .modern-btn-outline:hover { background: #f1f5f9; color:#1e293b; border-color: #94a3b8; }
        .table-section { background: #ffffff; border-radius: 15px; border:1px solid #e2e8f0; overflow:hidden; }
        .table-header { padding:25px; border-bottom:1px solid #e2e8f0; display:flex; justify-content:space-between; align-items:center; }
        .table-title { display:flex; align-items:center; gap:10px; font-size:18px; font-weight:600; color:#1e293b; margin:0; }
        .modern-table-container { overflow-x:auto; }
        .modern-table { width:100%; border-collapse: collapse; }
        .modern-table th { background: #f1f5f9; padding:15px; text-align:left; font-weight:600; color:#1e40af; border-bottom: 2px solid #cbd5e1; font-size:14px; }
        .modern-table td { padding:15px; border-bottom:1px solid #f1f5f9; color:#334155; vertical-align:middle; }
        ...
        .action-view { background: #dbeafe; color:#0284c7; text-decoration:none; }
        .action-edit { background: #dbeafe; color:#3b82f6; text-decoration:none; }
        ...
        .thumb { width:40px; height:40px; border-radius:8px; object-fit:cover; border:2px solid #bfdbfe; }
        .record-count { color: #64748b; }
        .date-text { color: #334155; }
        .time-text { color: #64748b; }
        .text-muted { color: #94a3b8; }
        .modern-table td.text-center { color: #64748b !important; }
    </style>
