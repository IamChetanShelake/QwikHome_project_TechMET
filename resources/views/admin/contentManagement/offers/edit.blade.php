...
<div class="modern-edit-container">
    ...
    <div class="edit-header-section">
        <div class="header-content">
            ...
            <div class="header-text">
                <h1 class="header-title">Edit Offer</h1>
                <p class="header-subtitle">Update offer details and settings</p>
            </div>
        </div>
        <div class="header-actions">
            ...
            <a href="{{ route('contentManagement.offers.show', $offer) }}" class="modern-btn modern-btn-outline">
    ...
    <div class="form-container">
        <form method="POST" action="{{ route('contentManagement.offers.update', $offer) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="title" value="{{ old('title', $offer->title) }}" placeholder="Enter offer title">
                    @error('title')
            ...
            <div class="form-row">
                <div class="form-group-full">
                    ...
                    <textarea class="form-textarea" name="description" placeholder="Enter offer description">{{ old('description', $offer->description) }}</textarea>
                    @error('description')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="current-image-section">
                        @if($offer->image)
                            <div class="current-image">
                                <img src="{{ asset('offer_images/' . $offer->image) }}" alt="{{ $offer->title }}" class="current-image-preview">
                                <div class="current-image-info">
                                    <span>Current image: {{ $offer->image }}</span>
                                    <a href="{{ asset('offer_images/' . $offer->image) }}" target="_blank" class="image-link">View Full Size</a>
                                </div>
                            </div>
                        @else
                            <div class="no-image">
