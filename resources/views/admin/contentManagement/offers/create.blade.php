...
<div class="modern-create-container">
    ...
    <div class="create-header-section">
        <div class="header-content">
            ...
            <div class="header-text">
                <h1 class="header-title">Create Offers</h1>
                <p class="header-subtitle">Add promotional offers and discount content</p>
            </div>
        </div>
        <div class="header-actions">
            <a href="{{ route('contentManagement.offers.index') }}" class="modern-btn modern-btn-outline">
    ...
    <div class="form-container">
        <form id="bulkOfferForm" method="POST" action="{{ route('contentManagement.offers.store') }}"
            ...
            <div class="form-actions">
                <button type="button" id="addOfferBtn" class="modern-btn modern-btn-secondary">
...
<script>
    ...
    function createOfferEntry(index) {
        const offerHtml = `
            <div class="offer-entry" data-index="${index}">
                <div class="offer-header">
                    <div class="offer-number">Offer ${index + 1}</div>
                    ${index > 0 ? '<button type="button" class="remove-offer-btn" onclick="removeOffer(this)">Remove</button>' : ''}
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="titles[${index}]" placeholder="Enter offer title">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group-full">
                        ...
                        <textarea class="form-textarea" name="descriptions[${index}]" placeholder="Enter offer description"></textarea>
                    </div>
                </div>
    ...
    function addOffer() {
        ...
        const offerHtml = createOfferEntry(offerCount);
        container.insertAdjacentHTML('beforeend', offerHtml);
        offerCount++;
    }

    function removeOffer(button) {
        const offerEntry = button.closest('.offer-entry');
        offerEntry.remove();

        // Renumber remaining offers
        const offers = document.querySelectorAll('.offer-entry');
        offers.forEach((offer, index) => {
            const numberElement = offer.querySelector('.offer-number');
            numberElement.textContent = `Offer ${index + 1}`;

            // Update input names
            const inputs = offer.querySelectorAll('input, textarea, select');
            ...
            // Update labels
            const labels = offer.querySelectorAll('label[for]');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('bulkOfferForm').addEventListener('submit', function(e) {
