        ...
        <div class="create-header-section">
            <div class="header-content">
                ...
                <div class="header-text">
                    <h1 class="header-title">Create Disclaimer</h1>
                    <p class="header-subtitle">Add new disclaimer content for your website</p>
                </div>
            </div>
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('contentManagement.disclaimers-policies.store') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-input form-textarea" name="content" placeholder="Enter disclaimer content">{{ old('content') }}</textarea>
                </div>
