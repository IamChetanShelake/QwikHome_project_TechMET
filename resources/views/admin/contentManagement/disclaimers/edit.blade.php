        ...
        <div class="edit-header-section">
            <div class="header-content">
                ...
                <div class="header-text">
                    <h1 class="header-title">Edit Disclaimer</h1>
                    <p class="header-subtitle">Modify disclaimer content</p>
                </div>
            </div>
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('contentManagement.disclaimers.update', $disclaimer) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-input form-textarea" name="content" placeholder="Enter disclaimer content">{{ old('content', $disclaimer->content) }}</textarea>
                </div>
