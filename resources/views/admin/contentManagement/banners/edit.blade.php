...
@section('content')
    ...
    <div class="modern-edit-container">
        ...
        <div class="edit-header-section">
            <div class="header-content">
                ...
                <div class="header-text">
                    <h1 class="header-title">Edit Banner</h1>
                    <p class="header-subtitle">Update banner details and settings</p>
                </div>
            </div>
            <div class="header-actions">
                ...
                <a href="{{ route('contentManagement.banners.show', $banner) }}" class="modern-btn modern-btn-outline">
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('contentManagement.banners.update', $banner) }}"
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="title" value="{{ old('title', $banner->title) }}"
                        ...
                        <div class="status-radio-group">
                            ...
                            <div class="radio-option">
                                <input type="radio" id="status_inactive" name="status" value="inactive"
                                    class="radio-input" {{ old('status', $banner->status) == 'inactive' ? 'checked' : '' }}>
                ...
                <div class="form-row">
                    <div class="form-group-full">
                        ...
                        <textarea class="form-textarea" name="description" placeholder="Enter banner description">{{ old('description', $banner->description) }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group-full">
                            ...
                            @if ($banner->image)
                                <div class="current-image">
                                    ...
                                    <div class="current-image-info">
                                        <span>Current image: {{ $banner->image }}</span>
                                        <a href="{{ asset('banner_images/' . $banner->image) }}" target="_blank"
                        ...
                        <small class="form-hint">Supported formats: JPG, PNG, GIF. Max size: 2MB. Leave empty to keep
                            current image.</small>
                        @error('image')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
