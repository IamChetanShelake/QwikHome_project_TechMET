            ...
            <div class="card-content">
                <div class="pricing-grid">
                    <div class="price-item">
                        ...
                        <span class="price-value">${{ number_format($service->price_onetime, 2) }}</span>
                    </div>
                    @if($service->price_weekly)
                        <div class="price-item">
                            <span class="price-label">Weekly</span>
                            <span class="price-value">${{ number_format($service->price_weekly, 2) }}</span>
                        </div>
                    @endif
                    @if($service->price_monthly)
                        <div class="price-item">
                            <span class="price-label">Monthly</span>
                            <span class="price-value">${{ number_format($service->price_monthly, 2) }}</span>
                        </div>
                    @endif
                    @if($service->price_yearly)
                        <div class="price-item">
                            <span class="price-label">Yearly</span>
                            <span class="price-value">${{ number_format($service->price_yearly, 2) }}</span>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="process-card">
                ...
                <div class="process-content">
                    ...
                    <div class="process-image">
                        <img src="{{ asset('Process_images/' . $process->image) }}" alt="{{ $process->title }}">
                    </div>
                    @endif
        ...
        <div class="requirements-grid">
            ...
            <div class="requirement-card">
                ...
                <div class="requirement-image">
                    <img src="{{ asset('Service_requirement_images/' . $requirement->image) }}" alt="{{ $requirement->title }}">
                </div>
                @endif
...
<style>
    ...
    /* Sections */
    .included-section, .processes-section, .requirements-section {
        background: rgba(255, 255, 255, 0.05);
        backdrop-filter: blur(10px);
        border-radius: 15px;
        border: 1px solid rgba(255, 255, 255, 0.1);
