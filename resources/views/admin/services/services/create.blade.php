    ...
    <div class="dashboard-card">
        <form method="POST" action="{{ route('services.services.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="price" id="price" value="{{ old('price') }}" step="0.01" min="0" class="filter-input" required>
                @error('price')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="duration" id="duration" value="{{ old('duration') }}" class="filter-input" placeholder="e.g., 2 hours">
                @error('duration')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
