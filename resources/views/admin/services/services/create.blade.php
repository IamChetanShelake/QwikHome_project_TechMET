        ...
        <div class="dashboard-card p-3">
            <form method="POST" action="{{ route('services.services.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="short_description" id="short_description" class="message-textarea">{{ old('short_description') }}</textarea>
                        ...
                        @if(old('requirements'))
                            @foreach(old('requirements') as $index => $req)
                                <div class="requirement-item" style="border-bottom: 1px solid #ddd; padding: 10px 0; margin-bottom: 10px;">
                                    <input type="text" name="requirements[{{ $index }}][title]" class="filter-input" placeholder="Title" style="margin-bottom: 10px; width: 100%;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price_onetime" id="price_onetime" value="{{ old('price_onetime') }}" step="0.01"
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price_weekly" id="price_weekly" value="{{ old('price_weekly') }}" step="0.01"
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price_monthly" id="price_monthly" value="{{ old('price_monthly') }}" step="0.01"
                        min="0" class="filter-input">
                    @error('price_monthly')
                        <div class="error">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price_yearly" id="price_yearly" value="{{ old('price_yearly') }}" step="0.01"
                        min="0" class="filter-input">
                    @error('price_yearly')
                        <div class="error">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="is_arabic" id="is_arabic" value="1" {{ old('is_arabic') ? 'checked' : '' }}>
                    @error('is_arabic')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Requirements
        let reqIndex = {{ count(old('requirements', [1])) }} + 1; // Start from max existing index + 1
