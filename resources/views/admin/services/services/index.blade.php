...
.form-actions {
    ...
    <div class="filter-bar">
        <form method="GET" class="filter-group">
            <input type="text" name="search" value="{{ $search }}" placeholder="Search services..." class="filter-input">
            ...
            <select name="subcategory_id" class="filter-select">
                ...
                <option value="{{ $sub->id }}" {{ $subcategory_id == $sub->id ? 'selected' : '' }}>{{ $sub->name }}</option>
                @endforeach
            </select>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="status-badge {{ $service->status == 'active' ? 'completed' : 'pending' }}">
