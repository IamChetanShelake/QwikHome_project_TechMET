                    ...
                    @forelse($subcategories as $subcategory)
                        <tr class="table-row">
                            ...
                            <td class="td-description">
                                <span class="description-text">{{ Str::limit($subcategory->description ?: 'No description', 50) }}</span>
                            </td>
                            <td class="td-status">
                                <span class="status-badge status-{{ $subcategory->status }}">
                                    <i class="fas fa-{{ $subcategory->status == 'active' ? 'check-circle' : 'times-circle' }}"></i>
                            ...
                            <td class="td-actions">
                                ...
                                <form id="deleteForm{{ $subcategory->id }}" method="POST" 
                                      action="{{ route('services.subcategories.destroy', $subcategory) }}" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
