        ...
        <div class="form-header-section">
            <div class="form-header-content">
                ...
                <div class="form-header-text">
                    <h1 class="form-title">Edit Subcategory</h1>
                    <p class="form-subtitle">Update subcategory information and settings</p>
                </div>
            </div>
                        ...
                        <div class="input-wrapper">
                            <select name="category_id" id="category_id" class="modern-select" required>
                                ...
                                @foreach ($categories as $cat)
                                    <option value="{{ $cat->id }}"
                                        {{ $subcategory->category_id == $cat->id ? 'selected' : '' }}>{{ $cat->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="name" id="name"
                                value="{{ old('name', $subcategory->name) }}" class="modern-input"
