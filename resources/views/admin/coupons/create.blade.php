...
@section('content')
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="modern-input @error('code') error @enderror" id="code"
                                    name="code" placeholder="Enter unique coupon code (e.g. SUMMER2024)" required>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="number" min="1"
                                    ...
                                    name="usage_limit" placeholder="Leave empty for unlimited">
                                <div class="input-border"></div>
                            </div>
                            @error('usage_limit')
                                <div class="error-message">
                        ...
                        <div class="form-group-modern full-width">
                            ...
                            <div class="service-selection-container">
                                ...
                                <div class="applicability-options">
                                    <div class="radio-group">
                                        <div class="radio-option">
                                            <input type="radio" id="all_services" name="applicable_to" value="all_services" checked>
                                ...
                                <div id="service-selection-panel" class="service-selection-panel" style="display: none;">
                                    <div class="selection-grid">
                                        ...
                                        <div class="form-group-modern">
                                            ...
                                            <div class="input-wrapper">
                                                ...
                                                <select class="modern-select" id="subcategory_filter" name="subcategory_filter" disabled>
    ...
    <script>
        ...
        function resetForm() {
            ...
            document.querySelectorAll('.modern-input.error, .modern-select.error, .modern-textarea.error').forEach(
                input => {
                    input.classList.remove('error');
                });
            // Reset dynamic elements
            document.getElementById('valueSuffix').textContent = '%';
            document.getElementById('valueHint').textContent = 'Enter percentage value (e.g., 10 for 10%)';
        }
    </script>
@endsection
