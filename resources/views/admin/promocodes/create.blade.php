...
@section('content')
                ...
                <div class="form-header-content">
                    <div class="form-title-group">
                        <div class="form-icon-wrapper">
                            <i class="fas fa-tags form-main-icon"></i>
                        </div>
                        <div class="form-title-text">
                            <h2 class="form-title">Create Promocode</h2>
                            <p class="form-subtitle">Generate new promotional codes for customer discounts</p>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group-modern full-width">
                            ...
                            <div class="toggle-wrapper">
                                <input type="hidden" name="for_active_subscription" id="for_active_subscription_hidden" value="0">
                                <div class="toggle-switch" id="toggleSwitch">
                                    <div class="toggle-option" data-value="0">
                                        <i class="fas fa-times"></i>
                                        <span>No</span>
                                    </div>
                                    <div class="toggle-option active" data-value="1">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set initial state (default to Yes/1)
