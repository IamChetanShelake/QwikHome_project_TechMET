...
<head>
    ...
    <style>
        /* Complete black theme override for Laravel welcome page */
        body,
        html {
        ...
        /* Header and navigation - clean black theme */
        nav {
            background-color: #000000 !important;
        ...
        /* Left content panel - Laravel info */
        .flex-1 {
        ...
        /* Right side Laravel logo container */
        .bg-[#fff2f2],
        .bg-[#1D0002] {
        ...
        /* Laravel logo text - make it white */
        .text-[#F53003],
        .text-[#F61500] {
            color: #ffffff !important;
        }

        /* Footer - comprehensive black theme */
        footer {
            background-color: #000000 !important;
            color: #ffffff !important;
        ...
        .shadow-\[0px_0px_1px_0px_rgba\(0\,0\,0\,0\.03\)\,0px_1px_2px_0px_rgba\(0\,0\,0\,0\.06\)\] {
            box-shadow: 0px 0px 10px rgba(255, 255, 255, 0.1), 0px 2px 8px rgba(255, 255, 255, 0.05) !important;
        }

        .dark\:shadow-\[inset_0px_0px_0px_1px_\#fffaed2d\] {
            box-shadow: inset 0px 0px 0px 2px rgba(255, 255, 255, 0.1) !important;
        }
...
<body
    ...
    <footer class="text-white section-dark">
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-md-12">
                    <div class="d-lg-flex align-items-center justify-content-between text-center">
                        <div>
                            <img src="{{ asset('website/assets/Gokhale-logo.png') }}"
                                style="height: 100px; width: 100px;" alt=""><br>
            ...
            <div class="container">
                <div class="row text-center text-md-start">
                    <div class="col-12 col-md-6 mb-2 mb-md-0">
                        Copyright 2025 - All Rights Reserved by Qwikhom
                    </div>
