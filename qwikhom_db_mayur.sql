...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2025 at 10:30 AM
...
(1, 11, '\"mayur, 9172593150\"', '\"near business bay\"', NULL, 0, '2025-10-09 05:57:35', '2025-10-09 05:58:34');
...
(17, NULL, NULL, 'active', '1759918130_0_68e63832d2d72.jpg', '2025-10-08 08:38:50', '2025-10-08 08:38:50'),
(18, NULL, NULL, 'active', '1759918130_1_68e63832d447e.jpg', '2025-10-08 08:38:50', '2025-10-08 08:38:50'),
(19, NULL, NULL, 'active', '1759918130_2_68e63832d4906.jpg', '2025-10-08 08:38:50', '2025-10-08 08:38:50');
...
CREATE TABLE `carts` (
  ...
  `applied_coupons` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`applied_coupons`)),
  `cart_metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`cart_metadata`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cart_items` (
  ...
  `item_type` enum('service','subscription_plan','combo_offer','addon_only') NOT NULL,
  ...
  `service_frequency_id` bigint(20) UNSIGNED DEFAULT NULL,
  ...
  `combo_services_config` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`combo_services_config`)),
  `combo_discount_applied` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`combo_discount_applied`)),
  `selected_addons` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`selected_addons`)),
  `addon_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`addon_details`)),
  `base_price` decimal(10,2) NOT NULL,
  `addons_price` decimal(10,2) NOT NULL DEFAULT 0.00,
  `discount_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `discount_reason` varchar(255) DEFAULT NULL,
  `tax_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `custom_configurations` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`custom_configurations`)),
  `customer_notes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`customer_notes`)),
  ...
  `preferred_service_provider_id` bigint(20) UNSIGNED DEFAULT NULL,
  `status` enum('active','removed','saved_for_later') NOT NULL DEFAULT 'active',
...
(1, 'Waxing', NULL, 'active', '2025-10-02 23:47:37', '2025-10-02 23:47:37', NULL),
...
CREATE TABLE `combo_offers` (
  ...
  `max_bookings_per_customer` int(11) DEFAULT NULL,
...
CREATE TABLE `combo_offer_services` (
  ...
  `service_id` bigint(20) UNSIGNED NOT NULL,
  `quantity` int(11) NOT NULL DEFAULT 1,
  `pricing_type` enum('standard','included','discounted') NOT NULL,
...
CREATE TABLE `complaints` (
  ...
  `complainant_type` enum('customer','service_provider') NOT NULL,
  `complaint_type` enum('late_delivery','poor_service','payment_issue','fraud','product_quality','communication','other') NOT NULL,
  ...
  `resolution_action` enum('refund','replacement','account_blocked','warning','none','other') DEFAULT NULL,
...
CREATE TABLE `feedbacks` (
  ...
  `rating_employee` tinyint(3) UNSIGNED DEFAULT NULL,
...
(2, 1, 'test proces', 'process desc', '1759819363_process_0_mothersday.jpeg', 0, '2025-10-07 05:12:43', '2025-10-07 05:12:43'),
...
CREATE TABLE `services` (
  ...
  `name` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  `whats_include` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`whats_include`)),
  `short_description` text DEFAULT NULL,
  `price_onetime` decimal(10,2) DEFAULT NULL,
  `price_onetime_description` text DEFAULT NULL,
  `duration_onetime` varchar(255) DEFAULT NULL,
  `price_weekly` decimal(10,2) DEFAULT NULL,
  `price_weekly_description` text DEFAULT NULL,
  `price_monthly` decimal(10,2) DEFAULT NULL,
  `price_monthly_description` text DEFAULT NULL,
  `price_yearly` decimal(10,2) DEFAULT NULL,
  `price_yearly_description` text DEFAULT NULL,
...
INSERT INTO `services` (`id`, `category_id`, `subcategory_id`, `name`, `description`, `whats_include`, `short_description`, `price_onetime`, `price_onetime_description`, `duration_onetime`, `price_weekly`, `price_weekly_description`, `price_monthly`, `price_monthly_description`, `price_yearly`, `price_yearly_description`, `is_arabic`, `duration`, `status`, `created_at`, `updated_at`, `media`, `qwikpick`, `beauty_and_easy`, `average_rating`) VALUES
(1, 1, 1, 'salon', 'Ullamco nemo vel eve', '[\"test inclusion desc\"]', 'long desc added', 117.00, NULL, NULL, 118.00, NULL, 119.00, NULL, 200.00, NULL, 1, '2  hours', 'active', '2025-10-02 23:48:49', '2025-10-08 09:40:09', '1759819362_Black Minimal Motivation Quote LinkedIn Banner.png', 0, 1, 0.0),
(2, 2, 2, 'Maids – Subscription & on-demand cleaning', 'Professional house cleaning services available on subscription or one-time basis', NULL, NULL, 500.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2-4 hours', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:19', NULL, 0, 1, 0.0),
(3, 2, 2, 'Deep Cleaning – Kitchen, bathroom, full home', 'Thorough deep cleaning of kitchen, bathroom, and entire home', NULL, NULL, 2000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '4-6 hours', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:21', NULL, 0, 1, 0.0),
(4, 2, 2, 'Move-in/Move-out Cleaning', 'Specialized cleaning service for property transitions', NULL, NULL, 3000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '6-8 hours', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:26', NULL, 1, 0, 0.0),
(5, 2, 2, 'Refrigerator Cleaning', 'Professional refrigerator deep cleaning and sanitization', NULL, NULL, 800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2 hours', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:27', NULL, 1, 0, 0.0),
(6, 2, 3, 'Laundry at Home – Ironing, folding, wardrobe assistance', 'Complete laundry service including ironing, folding, and wardrobe organization', NULL, NULL, 600.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '3-4 hours', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:29', NULL, 1, 0, 0.0),
(7, 2, 3, 'Laundry Collection – Clothes, carpets, shoes', 'Professional laundry collection service for clothes, carpets, and shoes', NULL, NULL, 300.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2 hours', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:16', NULL, 0, 1, 0.0),
(8, 2, 4, 'Pest Control', 'Professional pest management and extermination services', NULL, NULL, 1500.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2-3 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(9, 2, 4, 'Disinfection Services', 'Complete disinfection and sanitization of home spaces', NULL, NULL, 1000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2-3 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(10, 2, 5, 'Movers and Packers for home/office relocation', 'Professional moving and packing services for home or office relocation', NULL, NULL, 5000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Full day', 'active', '2025-10-03 00:06:31', '2025-10-08 09:40:32', NULL, 1, 0, 0.0),
(11, 3, 6, 'Nanny Services', 'Professional childcare and nanny services for families', NULL, NULL, 800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '4-8 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(12, 3, 7, 'Post-Maternity Care Staff', 'Post-delivery maternal care and newborn assistance', NULL, NULL, 1200.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '12-24 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(14, 3, 9, 'Cook Services – 2 meals/day, 2-hour schedule', 'Home cooking service providing 2 meals per day with 2-hour schedule', NULL, NULL, 1000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(16, 4, 11, 'Salon Services – Unisex + kids (hair, waxing, facial, grooming)', 'Complete salon services including hair, waxing, facial, and grooming for all ages', NULL, NULL, 800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-3 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(17, 4, 12, 'Spa Services – Massage, mani-pedi', 'Professional spa services including massage therapy and pedicure', NULL, NULL, 1200.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-2 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(18, 5, 13, 'Curtains & Blinds – Installation & repair', 'Professional installation and repair of curtains and blinds', NULL, NULL, 1000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2-4 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(19, 5, 14, 'Painting Services', 'Professional interior and exterior painting services', NULL, NULL, 2500.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Full day', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(20, 5, 15, 'Carpentry & Furniture Repair', 'Woodworking and furniture repair and restoration services', NULL, NULL, 1200.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2-6 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(21, 5, 16, 'Home Appliance Maintenance – AC, fridge, washing machine', 'Maintenance and repair services for AC, refrigerator, and washing machine', NULL, NULL, 1200.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-3 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(22, 5, 17, 'Landscape Maintenance', 'Garden and outdoor space maintenance and landscaping', NULL, NULL, 800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2-4 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(23, 6, 18, 'Vehicle Recovery', 'Professional vehicle recovery and towing services', NULL, NULL, 800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Variable', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(24, 6, 18, 'Vehicle Renewal Services', 'Help with vehicle registration renewal and documentation', NULL, NULL, 1500.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-2 days', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(25, 6, 18, 'Bicycle Maintenance', 'Bicycle repair and maintenance services', NULL, NULL, 400.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-2 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(26, 6, 19, 'Family Visa Renewal Services', 'Assistance with family visa renewal and documentation', NULL, NULL, 3000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-2 weeks', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(27, 7, 20, 'Party Organizer', 'Complete party planning and organization services', NULL, NULL, 5000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Event-based', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(28, 7, 21, 'Pet Care & Grooming – Bathing, nail trimming, brushing', 'Complete pet care including bathing, nail trimming, and grooming services', NULL, NULL, 600.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1-2 hours', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL, 0, 0, 0.0),
(32, 2, 6, 'baby care', 'test', '[\"test\",\"test\"]', 'test baby care', 100.00, NULL, NULL, 10.00, NULL, 20.00, NULL, 30.00, NULL, 0, NULL, 'active', '2025-10-10 07:57:47', '2025-10-10 09:48:18', '1760095098_logo (1).png', 0, 0, 0.0),
(33, 2, 3, 'laundry 1', 'test', '[\"test\",\"test\"]', 'test', 10.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'active', '2025-10-10 10:00:23', '2025-10-10 10:00:23', '1760095823_61yy3cVsjvL.jpg', 0, 0, 0.0),
(34, 5, 10, 'Hoyt Hunt', 'Vel similique minima', '[\"Velit eos voluptatu\"]', 'Officia expedita ess', 753.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'inactive', '2025-10-10 10:15:55', '2025-10-10 10:15:55', '1760096755_logo (1).png', 0, 0, 0.0),
(35, 3, 12, 'Sybill Mays', 'Quisquam expedita ad', '[\"Et officia pariatur\"]', 'Praesentium necessit', 134.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'inactive', '2025-10-10 10:35:37', '2025-10-10 10:35:37', '1760097937_61JfZmU4WjL.jpg', 0, 0, 0.0),
(36, 8, 11, 'Allen Cruz', 'Veniam omnis vero a', '[\"Facilis veniam quis\"]', 'Enim excepteur volup', 284.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'inactive', '2025-10-10 10:48:51', '2025-10-10 10:48:51', '1760098731_61B1WzJ426L.jpg', 0, 0, 0.0),
(37, 6, 7, 'testn1', 'Unde deserunt qui ne', '[\"Reprehenderit eu con\"]', 'Dolores minus in aut', 962.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'active', '2025-10-13 03:19:09', '2025-10-13 03:19:09', '', 0, 0, 0.0),
(38, 3, NULL, 'Joan George', 'Mollit delectus est', '[\"Dolor cupidatat tene\"]', 'Ullam laboriosam di', 389.00, NULL, NULL, 340.00, NULL, NULL, NULL, 354.00, NULL, 0, 'Sequi et Nam sint do', 'inactive', '2025-10-13 03:53:26', '2025-10-13 03:54:01', '', 0, 0, 0.0),
(39, 8, 6, 'Anthony Dickson', 'Quia dolor reprehend', '[\"Deserunt omnis illum\"]', 'Ad nobis eum officia', 470.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'inactive', '2025-10-13 03:55:10', '2025-10-13 03:55:10', '', 0, 0, 0.0),
(40, 2, 3, 'Arden Ewing', 'Ea blanditiis totam', '[\"Nulla vel cum autem\"]', 'Minus amet inventor', 99.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'active', '2025-10-13 04:15:14', '2025-10-13 04:15:14', '', 0, 0, 0.0),
(41, 3, 17, 'Pamela Thornton', 'Fugit facere Nam ut', '[\"Nihil odit veniam r\"]', 'Fuga Nostrum invent', 909.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'inactive', '2025-10-13 04:25:22', '2025-10-13 04:25:22', '', 0, 0, 0.0),
(44, 3, 9, 'Tyrone Kidd', 'Dignissimos qui fuga', '[\"Ut maxime quos quam\"]', 'Sit eos sed minus no', 519.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'inactive', '2025-10-13 04:55:13', '2025-10-13 04:55:13', '', 0, 0, 0.0),
(45, 3, 12, 'Brenna Riley', 'Qui minus ullamco of', '[\"Veritatis eveniet v\"]', 'Nostrud reprehenderi', 44.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'inactive', '2025-10-13 05:06:38', '2025-10-13 05:06:38', '', 0, 0, 0.0),
(46, 5, 18, 'Lance Morin', 'Ad a aute dolorem se', '[\"Accusantium officiis\"]', 'Adipisci assumenda c', 45.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'inactive', '2025-10-13 05:08:44', '2025-10-13 05:08:44', '', 0, 0, 0.0),
(47, 1, 11, 'August Terrell', 'Sunt qui unde nisi', '[\"Dolorem eveniet min\"]', 'Pariatur At consect', 110.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'inactive', '2025-10-13 05:11:18', '2025-10-13 05:11:18', '', 0, 0, 0.0),
(48, 1, 1, 'test service', 'test', '[\"test\"]', 'test', 45.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'active', '2025-10-13 05:37:20', '2025-10-13 05:50:37', '1760340037_logo (1).png', 0, 0, 0.0);
...
CREATE TABLE `service_addons` (
  ...
  `type` enum('material','equipment','labor','premium','custom') NOT NULL DEFAULT 'custom',
...
CREATE TABLE `service_frequencies` (
  ...
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`description`)),
  `days_multiplier` int(11) NOT NULL DEFAULT 1,
  `status` enum('active','inactive') NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `service_frequency_options` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `service_id` bigint(20) UNSIGNED NOT NULL,
  `frequency_type` enum('weekly','monthly','yearly') NOT NULL,
...
CREATE TABLE `service_materials` (
  ...
  `applicable_to` enum('onetime','weekly','monthly','yearly','all') NOT NULL DEFAULT 'onetime',
...
(3, 1, 'test requirements', '1759819362_0_alex-machado-80sv993lUKI-unsplash.jpg', '2025-10-07 05:12:42', '2025-10-07 05:12:42'),
...
CREATE TABLE `service_subscription_plans` (
  ...
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`description`)),
  `base_price` decimal(10,2) NOT NULL,
  `billing_frequency_id` bigint(20) UNSIGNED NOT NULL,
  `duration_months` int(11) NOT NULL,
  `billing_cycle` enum('monthly','quarterly','yearly') NOT NULL DEFAULT 'monthly',
  `setup_fee` decimal(10,2) NOT NULL DEFAULT 0.00,
  `auto_renew` tinyint(1) NOT NULL DEFAULT 1,
  `renewal_reminder_days` int(11) NOT NULL DEFAULT 7,
  `included_addons` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`included_addons`)),
  `discount_percentage` decimal(5,2) NOT NULL DEFAULT 0.00,
  `max_services_per_period` int(11) NOT NULL DEFAULT 1,
...
('phGG5jk5IcuOFteynl9Q3CqnXEK7oA9GjcldwGUq', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '', 1760344107);
...
(1, 1, 'spatula waxing', NULL, 'active', '2025-10-02 23:48:08', '2025-10-02 23:48:08', NULL),
(2, 2, 'Cleaning Services', 'Professional cleaning and hygiene services', 'active', '2025-10-03 00:06:31', '2025-10-03 00:06:31', NULL),
...
CREATE TABLE `users` (
  ...
  `trade_license_document` varchar(255) DEFAULT NULL,
  `vat_certificate_document` varchar(255) DEFAULT NULL,
  `staff_documents` varchar(255) DEFAULT NULL,
  `contract_document` varchar(255) DEFAULT NULL,
  `payment_type` enum('fixed_rate','commission','revenue_share') NOT NULL DEFAULT 'commission',
  `fixed_rate_amount` decimal(10,2) DEFAULT NULL,
  `commission_rate` decimal(5,2) DEFAULT NULL,
  `revenue_share_ratio` varchar(255) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `image`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `role`, `active`, `is_deleted`, `deleted_at`, `address`, `application_document`, `trade_license_document`, `vat_certificate_document`, `staff_documents`, `contract_document`, `payment_type`, `fixed_rate_amount`, `commission_rate`, `revenue_share_ratio`, `average_rating`) VALUES
(1, 'Admin', 'admin@gmail.com', '1111111111', NULL, '2025-09-29 05:09:13', '$2y$12$jltDtsVVsQdN44eQPrJd0.pVa2O6sYi32GtCumw6PW.46Kw8mNGx.', 'MKGBfdGa2odIlscjRA53q1rIUQjrrkiS5iFN4A2sXMIiYQDRPavu2rVWcoAm', '2025-09-29 05:09:13', '2025-09-29 05:09:13', 'admin', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(2, 'Vendor', 'vendor@gmail.com', '5555555555', '1759494600.jpg', '2025-09-29 23:29:34', '$2y$12$NqOezJgewb68KlxAtXNdgu/Q2LLkiTUdNGIGysQ/tmSID6Z/rvqEu', 'NMlHZPHc2YALguL19ifZyxxzW7GqumzZRhylXNt8ipFclJ2GtT18kM17HOcI', '2025-09-29 23:29:34', '2025-10-03 07:00:00', 'vendor', 0, 0, NULL, 'nashik , india', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(3, 'user', 'user@gmail.com', '0000000000', NULL, '2025-09-29 23:29:34', '$2y$12$NM1NJ4s4a8/P0XkqFAfZd.Qo502cuY8Sge78WIhyEELo8BcCyDyBS', 'aacdjLqjKY', '2025-09-29 23:29:34', '2025-10-06 00:55:26', 'user', 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(6, 'chetan', 'chetan@gmail.com', '7777777777', '1759492396.jpg', NULL, '$2y$12$WfWRTBZJWNAjb5Mnc7/xD.95MuIrYuYmDxBNxEc5cgML0LBkgAmzC', NULL, '2025-10-03 06:23:16', '2025-10-03 06:23:16', 'serviceprovider', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(8, 'John Smith', 'john.smith@example.com', '+1987654321', NULL, NULL, '$2y$12$u9BdluXhEGt1BS9Eej4f8upoFRCymY9UB1USx6Jq5SBuMpmQ35aTa', NULL, '2025-10-03 23:43:13', '2025-10-03 23:43:13', 'serviceprovider', 1, 0, NULL, '456 Worker Ave, City, State 12346', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(9, 'Sarah Johnson', 'sarah.johnson@example.com', '+1555123456', NULL, NULL, '$2y$12$c7DX6OE.H.jdOyVngBmcZeY3699DTcsyHAgr.0qSnngSwifxRqAES', NULL, '2025-10-03 23:43:13', '2025-10-03 23:43:13', 'serviceprovider', 1, 0, NULL, '789 Provider Rd, City, State 12347', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(10, 'Mike Davis', 'mike.davis@example.com', '+1444987654', NULL, NULL, '$2y$12$XAG06NhLvozFbpTUmA4AAur9T/AMSe4Q4N3rTPu5MWgUKcbvyuJJS', NULL, '2025-10-03 23:43:13', '2025-10-03 23:43:13', 'serviceprovider', 1, 0, NULL, '321 Service Ln, City, State 12348', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(11, 'Alice Cooper', 'alice.cooper@example.com', '+1777123456', NULL, NULL, '$2y$12$/HfQm/RLJDhknsXiXU9sz.SnBlOiRJaz1.PhtRPZwMZioCm2vatw.', NULL, '2025-10-03 23:43:14', '2025-10-06 00:55:29', 'user', 0, 0, NULL, '111 Customer St, City, State 12349', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(12, 'Bob Wilson', 'bob.wilson@example.com', '+1666234567', NULL, NULL, '$2y$12$oNQLwKKC7pn0f.cEWiZmYuqRVRNgmiwcQ0OJ8romRdEMxy.yxOWt6', NULL, '2025-10-03 23:43:14', '2025-10-03 23:43:14', 'user', 0, 0, NULL, '222 Client Ave, City, State 12350', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(13, 'Carol Brown', 'carol.brown@example.com', '+1555345678', NULL, NULL, '$2y$12$cIiAVOIviqrMua9mw8aGtO8jAaQaDxC/Njok4w/2N9smnl6YcOT2i', NULL, '2025-10-03 23:43:14', '2025-10-06 00:55:06', 'user', 1, 0, NULL, '333 Patron Rd, City, State 12351', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(14, 'David Lee', 'david.lee@example.com', '+1444456789', NULL, NULL, '$2y$12$UHXTVSKimJ1b3OYegaQP1u6aLJMaT3nKMPYsAqNsmJBVXEgT5sYgq', NULL, '2025-10-03 23:43:15', '2025-10-06 00:29:09', 'user', 0, 1, '2025-10-08 06:47:00', '444 Consumer Ln, City, State 12352', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(15, 'new vendor', 'vendor2@gmail.com', '4556675645', '', NULL, '$2y$12$VhNY23Z7iG6.8e.6V1cwCeWsf8BWNidjIHmqCeUwfSbIa54CdzRJe', NULL, '2025-10-06 01:24:32', '2025-10-06 01:24:32', 'serviceprovider', 0, 0, NULL, 'wanowrie , pune , india', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00),
(17, 'employee', 'emp@gmail.com', '5656565656', '', NULL, '$2y$12$XWU/bCM/y1qc/wFHr5rglekWAKmT77R1uEqzr1q8f3vR1G0ROZfp2', NULL, '2025-10-06 01:50:02', '2025-10-06 01:50:02', 'serviceprovider', 0, 0, NULL, 'nashik', NULL, NULL, NULL, NULL, NULL, 'commission', NULL, NULL, NULL, 0.00);
...
(1, 17, 5, '2025-10-06 01:50:02', '2025-10-06 01:50:02'),
(2, 17, 19, '2025-10-06 01:50:02', '2025-10-06 01:50:02'),
(3, 17, 24, '2025-10-06 01:50:02', '2025-10-06 01:50:02'),
(4, 17, 25, '2025-10-06 01:50:02', '2025-10-06 01:50:02'),
(5, 17, 26, '2025-10-06 01:50:02', '2025-10-06 01:50:02');
...
ALTER TABLE `cart_items`
  ...
  ADD CONSTRAINT `cart_items_service_frequency_id_foreign` FOREIGN KEY (`service_frequency_id`) REFERENCES `service_frequencies` (`id`) ON DELETE SET NULL,
